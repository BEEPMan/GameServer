...
inline ::PROTOBUF_NAMESPACE_ID::uint64 C_LEAVE_GAME::_internal_playerid() const {
  return playerid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 C_LEAVE_GAME::playerid() const {
  // @@protoc_insertion_point(field_get:Protocol.C_LEAVE_GAME.playerId)
  return _internal_playerid();
}
inline void C_LEAVE_GAME::_internal_set_playerid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  playerid_ = value;
}
inline void C_LEAVE_GAME::set_playerid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_playerid(value);
...
// uint64 playerId = 1;
inline void S_LEAVE_GAME::clear_playerid() {
  playerid_ = uint64_t{0u};
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_LEAVE_GAME::_internal_playerid() const {
  return playerid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 S_LEAVE_GAME::playerid() const {
  // @@protoc_insertion_point(field_get:Protocol.S_LEAVE_GAME.playerId)
  return _internal_playerid();
}
inline void S_LEAVE_GAME::_internal_set_playerid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  playerid_ = value;
}
inline void S_LEAVE_GAME::set_playerid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_playerid(value);
  // @@protoc_insertion_point(field_set:Protocol.S_LEAVE_GAME.playerId)
}
